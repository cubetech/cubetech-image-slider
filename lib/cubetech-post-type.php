...
function cubetech_image_slider_create_post_type() {
	register_post_type('cubetech_imgslider',
		array(
			'labels' => array(
				'name' => __('Bildslider'),
			...
			'public' => true,
			'has_archive' => false,
			'rewrite' => array('slug' => 'image-slider', 'with_front' => false),
			'show_ui' => true,
			'menu_position' => '20',
			'menu_icon' => null,
			'hierarchical' => true,
...
add_action('init', 'cubetech_image_slider_create_post_type');
